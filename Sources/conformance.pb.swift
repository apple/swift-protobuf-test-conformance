...
public struct Conformance_ConformanceRequest: ProtobufGeneratedMessage {
  ...
  public var anyTypeURL: String {return "type.googleapis.com/conformance.ConformanceRequest"}
...
public struct Conformance_ConformanceResponse: ProtobufGeneratedMessage {
  ...
  public var protoPackageName: String {return "conformance"}
  public var anyTypeURL: String {return "type.googleapis.com/conformance.ConformanceResponse"}
  public var jsonFieldNames: [String: Int] {return [
    "parseError": 1,
    "serializeError": 6,
    "runtimeError": 2,
...
public struct Conformance_TestAllTypes: ProtobufGeneratedMessage {
  ...
  public var protoPackageName: String {return "conformance"}
  public var anyTypeURL: String {return "type.googleapis.com/conformance.TestAllTypes"}
  public var jsonFieldNames: [String: Int] {return [
    "optionalInt32": 1,
    "optionalInt64": 2,
    "optionalUint32": 3,
  ...
  private class _StorageClass {
    ...
    func decodeField(setter: inout ProtobufFieldDecoder, protoFieldNumber: Int) throws -> Bool {
      ...
      case 413: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &__FieldName13)
      case 414: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &__FieldName14)
      case 415: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &_field_Name15)
      case 416: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &_field_Name16)
      case 417: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &_fieldName17__)
      case 418: handled = try setter.decodeSingularField(fieldType: ProtobufInt32.self, value: &_fieldName18__)
      default:
        handled = false
      }
      return handled
    ...
    func traverse(visitor: inout ProtobufVisitor) throws {
      ...
      if __FieldName13 != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: __FieldName13, protoFieldNumber: 413, protoFieldName: "__field_name13", jsonFieldName: "FieldName13", swiftFieldName: "_FieldName13")
      }
      if __FieldName14 != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: __FieldName14, protoFieldNumber: 414, protoFieldName: "__Field_name14", jsonFieldName: "FieldName14", swiftFieldName: "_FieldName14")
      }
      if _field_Name15 != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: _field_Name15, protoFieldNumber: 415, protoFieldName: "field__name15", jsonFieldName: "fieldName15", swiftFieldName: "field_Name15")
      }
      if _field_Name16 != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: _field_Name16, protoFieldNumber: 416, protoFieldName: "field__Name16", jsonFieldName: "fieldName16", swiftFieldName: "field_Name16")
      }
      if _fieldName17__ != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: _fieldName17__, protoFieldNumber: 417, protoFieldName: "field_name17__", jsonFieldName: "fieldName17", swiftFieldName: "fieldName17__")
      }
      if _fieldName18__ != 0 {
        try visitor.visitSingularField(fieldType: ProtobufInt32.self, value: _fieldName18__, protoFieldNumber: 418, protoFieldName: "Field_name18__", jsonFieldName: "fieldName18", swiftFieldName: "fieldName18__")
      }
    }
    ...
    var isEmpty: Bool {
      ...
      if __FieldName13 != 0 {return false}
      if __FieldName14 != 0 {return false}
      if _field_Name15 != 0 {return false}
      if _field_Name16 != 0 {return false}
      if _fieldName17__ != 0 {return false}
      if _fieldName18__ != 0 {return false}
      return true
    }
  ...
  public enum OneOf_OneofField: ExpressibleByNilLiteral, ProtobufOneofEnum {
    ...
    public mutating func decodeField(setter: inout ProtobufFieldDecoder, protoFieldNumber: Int) throws -> Bool {
      ...
      case 119:
        ...
        handled = try setter.decodeSingularField(fieldType: Conformance_TestAllTypes.NestedEnum.self, value: &value)
    ...
    public func traverse(visitor: inout ProtobufVisitor, start: Int, end: Int) throws {
      ...
      case .oneofBool(let v):
        if start <= 115 && 115 < end {
          try visitor.visitSingularField(fieldType: ProtobufBool.self, value: v, protoFieldNumber: 115, protoFieldName: "oneof_bool", jsonFieldName: "oneofBool", swiftFieldName: "oneofBool")
        }
      case .oneofUint64(let v):
        if start <= 116 && 116 < end {
          try visitor.visitSingularField(fieldType: ProtobufUInt64.self, value: v, protoFieldNumber: 116, protoFieldName: "oneof_uint64", jsonFieldName: "oneofUint64", swiftFieldName: "oneofUint64")
        }
      case .oneofFloat(let v):
        if start <= 117 && 117 < end {
          try visitor.visitSingularField(fieldType: ProtobufFloat.self, value: v, protoFieldNumber: 117, protoFieldName: "oneof_float", jsonFieldName: "oneofFloat", swiftFieldName: "oneofFloat")
        }
      case .oneofDouble(let v):
        if start <= 118 && 118 < end {
          try visitor.visitSingularField(fieldType: ProtobufDouble.self, value: v, protoFieldNumber: 118, protoFieldName: "oneof_double", jsonFieldName: "oneofDouble", swiftFieldName: "oneofDouble")
        }
      case .oneofEnum(let v):
        if start <= 119 && 119 < end {
          try visitor.visitSingularField(fieldType: Conformance_TestAllTypes.NestedEnum.self, value: v, protoFieldNumber: 119, protoFieldName: "oneof_enum", jsonFieldName: "oneofEnum", swiftFieldName: "oneofEnum")
        }
      case .None:
        break
      }
  ...
  public struct NestedMessage: ProtobufGeneratedMessage {
    ...
    public var protoPackageName: String {return "conformance"}
    public var anyTypeURL: String {return "type.googleapis.com/conformance.TestAllTypes.NestedMessage"}
    public var jsonFieldNames: [String: Int] {return [
      "a": 1,
      "corecursive": 2,
    ]}
  ...
  public var oneofBool: Bool? {
    get {
      if let storage = _storage {
        if case .oneofBool(let v) = storage._oneofField {
          return v
        }
      }
      return nil
  ...
  public var oneofUint64: UInt64? {
    get {
      if let storage = _storage {
        if case .oneofUint64(let v) = storage._oneofField {
          return v
        }
      }
      return nil
  ...
  public var oneofFloat: Float? {
    get {
      if let storage = _storage {
        if case .oneofFloat(let v) = storage._oneofField {
          return v
        }
      }
      return nil
  ...
  public var oneofDouble: Double? {
    get {
      if let storage = _storage {
        if case .oneofDouble(let v) = storage._oneofField {
          return v
        }
      }
      return nil
  ...
  public init(optionalInt32: Int32? = nil,
    ...
    oneofEnum: Conformance_TestAllTypes.NestedEnum? = nil,
    ...
    _FieldName13: Int32? = nil,
    _FieldName14: Int32? = nil,
    field_Name15: Int32? = nil,
    field_Name16: Int32? = nil,
    fieldName17__: Int32? = nil,
    fieldName18__: Int32? = nil)
  {
    let storage = _uniqueStorage()
    ...
    if let v = oneofBool {
      storage._oneofField = .oneofBool(v)
    }
    if let v = oneofUint64 {
      storage._oneofField = .oneofUint64(v)
    }
    if let v = oneofFloat {
      storage._oneofField = .oneofFloat(v)
    }
    if let v = oneofDouble {
      storage._oneofField = .oneofDouble(v)
    }
    if let v = oneofEnum {
    ...
    if let v = _FieldName13 {
      storage.__FieldName13 = v
    }
    if let v = _FieldName14 {
      storage.__FieldName14 = v
    }
    if let v = field_Name15 {
      storage._field_Name15 = v
    }
    if let v = field_Name16 {
      storage._field_Name16 = v
    }
    if let v = fieldName17__ {
      storage._fieldName17__ = v
    }
    if let v = fieldName18__ {
      storage._fieldName18__ = v
    }
  }
...
public struct Conformance_ForeignMessage: ProtobufGeneratedMessage {
  ...
  public var protoPackageName: String {return "conformance"}
  public var anyTypeURL: String {return "type.googleapis.com/conformance.ForeignMessage"}
  public var jsonFieldNames: [String: Int] {return [
    "c": 1,
  ]}
  public var protoFieldNames: [String: Int] {return [
